...
public class C22_Put_DeSerialization extends JsonPlaceHolderBaseURL {
    ...
    public void put01(){
        ...
        specJsonPlace.pathParams("pp1","posts","pp2",70);//url de 2 salsh olduğu için pp1 pp2 diye ayrıca yazıyoruz
        ...
        Response response = given()
                ...
                .when()
                .body(reqBody)//java kodu olduğu için to string yapmadık
                .put("/{pp1}/{pp2}");
        response.prettyPeek();
